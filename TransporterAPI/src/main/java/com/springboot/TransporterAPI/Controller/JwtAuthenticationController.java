...
//
//	@RequestMapping(value = "/transporter", method = RequestMethod.POST)
//	public ResponseEntity<?> createAuthenticationToken(@RequestBody PostTransporter authenticationRequest)
//			throws Exception {
//
