...
public class TransporterExceptionAdvice extends ResponseEntityExceptionHandler{
	...
	Logger logger =(Logger) LoggerFactory.getLogger(TransporterExceptionAdvice.class);
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        TransporterErrorResponse loadErrorResponse = new TransporterErrorResponse(HttpStatus.BAD_REQUEST);
    ...
    protected ResponseEntity<Object> handleEntityNotFound(
        ...
        TransporterErrorResponse loadErrorResponse = new TransporterErrorResponse(HttpStatus.NOT_FOUND);
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        TransporterErrorResponse  apiError = new TransporterErrorResponse(HttpStatus.BAD_REQUEST);
    ...
    protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        if (ex.getCause() instanceof ConstraintViolationException) {
            return buildResponseEntity(new TransporterErrorResponse(HttpStatus.CONFLICT, "Database error", ex.getCause()));
        }
    ...
    private ResponseEntity<Object> buildResponseEntity(TransporterErrorResponse loadErrorResponse) {
